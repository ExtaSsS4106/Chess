...
SECRET_KEY = 'django-insecure-vf2n!$q%57j*)dy%**ae-+wmhwtz35*q+p%i0@kk99^lf%g@02'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated',  # по умолчанию все API требуют авторизацию
    ),
}
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=3),   # access-токен 
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),      # refresh-токен живёт n дней
