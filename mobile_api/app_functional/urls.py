...
from .views.friends import Get_friends, Add_friend, Delete_from_friends, send_invite_to_friend, join_to_game
...
urlpatterns = [
    ...
    path('friends/join_to_game', join_to_game.as_view(), name='join_to_game'),
    # requests
