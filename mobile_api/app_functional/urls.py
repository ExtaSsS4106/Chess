...
from .views.friends import Get_friends, Add_friend, Delete_from_friends, send_invite_to_friend, invite_to_game
...
urlpatterns = [
    ...
    path('friends/invite_to_game', invite_to_game.as_view(), name='invite_to_game'),
    # requests
